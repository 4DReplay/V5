...
# ─────────────────────────────────────────────────────────────────────────────#
def draw_graph_title(str_title, frame, title_x, title_y, color = None, font_scale = 1, thickness = 2, is_draw_degree  = False, align_type = None):
    if color is None:
        color = conf._color_title
    if align_type is None:    
        align_type = conf._text_align_right
...
# [date] 2025-03-05
# ─────────────────────────────────────────────────────────────────────────────#
def draw_pitcher_multiline(type_mem, frame, frameindex, tot_count, arrs, arr_idx, pitch_type = None, speed = None, spinrate = None):

    if pitch_type is None: pitch_type = conf._pitch_type, 
    if speed is None: speed = conf._release_speed, 
    if spinrate is None: spinrate = conf._release_spinrate
    ...
    if type_mem == conf._file_type_curr:        
        ...
        frame = draw_fade_in_text_pitch(frame, pitch_type, spinrate, speed, conf._path_font_main, conf._pitch_box_x, conf._pitch_box_y, alpha)  
